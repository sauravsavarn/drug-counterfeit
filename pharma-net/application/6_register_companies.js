...
async function main(nameOfOrg, companyCRN, companyName, location, organisationRole) {
  try {
    console.log("main args : nameOfOrg = " + nameOfOrg + " - companyCRN = " + companyCRN + " - companyName = " + companyName + " - location = " + location + " - organisationRole = " + organisationRole);
...
module.exports.execute = function(nameOfOrg, companyCRN, companyName, location, organisationRole) {
    return main(nameOfOrg.toLowerCase(), companyCRN, companyName, location, organisationRole) 
};
// module.exports.execute = main(nameOfOrg, companyCRN, companyName, location, organisationRole);
