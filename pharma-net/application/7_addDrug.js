...
async function main(nameOfOrg, drugName, serialNo, mfgDate, expDate, companyCRN) {
  try {
    ...
    console.log("here here" + addDrugBuffer);
    // process response
...
module.exports.execute = function(nameOfOrg, drugName, serialNo, mfgDate, expDate, companyCRN) {
  return main(nameOfOrg.toLowerCase(), drugName, serialNo, mfgDate, expDate, companyCRN) 
};
// module.exports.execute = main;
//"registerCompany",drugName, serialNo, mfgDate, expDate, companyCRN;
