...
async function main(nameOfOrg, drugName, serialNo, retailerCRN, customerAadhar) {
  try {
...
module.exports.execute = function(nameOfOrg, drugName, serialNo, retailerCRN, customerAadhar) {
  return main(nameOfOrg.toLowerCase(), drugName, serialNo, retailerCRN, customerAadhar) 
};
// module.exports.execute = main;
//"registerCompany",drugName, serialNo, retailerCRN, customerAadhar;
