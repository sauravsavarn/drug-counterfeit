...
module.exports.execute = function(nameOfOrg, buyerCRN, sellerCRN, drugName, quantity) {
  return main(nameOfOrg.toLowerCase(), buyerCRN, sellerCRN, drugName, quantity) 
};
// module.exports.execute = main;
//"registerCompany",buyerCRN, sellerCRN, drugName, quantity;
