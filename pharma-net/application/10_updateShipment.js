...
async function main(nameOfOrg, buyerCRN, drugName, transporterCRN, organisationRole) {
  try {
    const pharmanetContract = await getContractInstance(nameOfOrg);

    console.log(".....Updating  a Shipment");
    console.log("updateShipment args : nameOfOrg = " + nameOfOrg + " - buyerCRN = " + buyerCRN + " - drugName = " + drugName + " - transporterCRN = " + transporterCRN);
    ...
    // let newUpdatedShipment = updateShipmentBuffer.toJSON();
    //console.log("newUpdatedShipment : " + newUpdatedShipment);
...
module.exports.execute = function(nameOfOrg, buyerCRN, drugName, transporterCRN, organisationRole) {
  return main(nameOfOrg.toLowerCase(), buyerCRN, drugName, transporterCRN, organisationRole) 
};
// module.exports.execute = main;
//"registerCompany",buyerCRN, drugName, transporterCRN;
